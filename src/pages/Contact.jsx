  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div className="flex items-center justify-center flex-col ">
        <h2 className="pt-12 text-center text-5xl text-gray-900 tracking-wider pb-6">
          Get In Touch
        </h2>
        <p className="w-[50%] mx-auto text-lg text-gray-900 pb-6 tracking-wider text-center font-poppins">
